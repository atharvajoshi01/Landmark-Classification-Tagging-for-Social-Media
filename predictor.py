...
class Predictor(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        with torch.no_grad():
            ...
            # 2. get the logits // The logistic model (or logit) is a classification model used to predict variables that can take only two values. a function that represents probability values from 0 to 1, and negative infinity to infinity
